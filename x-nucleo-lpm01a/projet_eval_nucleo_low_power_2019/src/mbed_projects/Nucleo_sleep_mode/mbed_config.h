...
#define CLOCK_SOURCE                                       USE_PLL_HSE_EXTC|USE_PLL_HSI                                                   // set by target:NUCLEO_L073RZ
#define LPTICKER_DELAY_TICKS                               4                                                                              // set by target:NUCLEO_L073RZ
...
#define MBED_CONF_TARGET_LPTICKER_LPTIM                    1                                                                              // set by target:NUCLEO_L073RZ
